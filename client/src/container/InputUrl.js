...
class InputUrl extends Component {
  constructor(props) {
    super(props);
    this.state = { value: "", loading: false, shortUrl: "", copied: false, error: false };
  ...
  render() {
    ...
    let button = (this.state.loading) ? <Spinner /> : <button className={classes.InputUrlButton}>Generate URL</button>;
    return (
